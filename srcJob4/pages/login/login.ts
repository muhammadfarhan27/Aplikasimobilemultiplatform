...
export class LoginPage {
 ...
 constructor(private navCtrl: NavController, private
userProvider: UserProvider, private platform: Platform,
...
this.showToast("Please fill completely username and
password!");
return null;
}
...
this.showToast("Username and password not available,
please sign up!");
}
});
}
